        ...
        onChange={(e)=>{console.log(e);
          props.setObjetoSelect({...props.ObjetoSelect,precio:e.target.value});setPrice(e.target.value)}}></input> */}
            ...
            <RangeSlider
              ...
              max={200000}
              onAfterChange={(e) => {
                console.log("resultado del onAfterChange: ", e);
                setValorFinal(props.ObjetoSelect.precio);
              }}
            />
            <p>
              Máx. precio: U$S
              {valorFinal.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.")}
            </p>
          </div>
          <div className="buttonForm">
            <button
              ...
              onClick={() => {
                console.log(
                  "resultado del onClick en Button: " +
                    props.ObjetoSelect.departamento.value +
                    props.ObjetoSelect.tipo_inmueble.value
                );
